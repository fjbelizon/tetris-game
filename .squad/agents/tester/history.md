...
*Last synced: 2026-04-07T15:15:47.749Z*
...
- [ ] T001 Create .NET solution and projects in TetrisGame.sln (Issue #127)
- [ ] T002 Create architecture folders and placeholders in TetrisGame/Domain/.gitkeep (Issue #128)
- [ ] T003 [P] Configure xUnit project reference and test runner in TetrisGame.Tests/TetrisGame.Tests.csproj (Issue #129)
- [ ] T004 [P] Set C# 14 language version in TetrisGame/TetrisGame.csproj (Issue #130)
- [ ] T005 [P] Add board invariants tests (10x20, bounds) in TetrisGame.Tests/Domain/BoardTests.cs (Issue #131)
- [ ] T006 Implement Board dimensions and bounds checks in TetrisGame/Domain/Board.cs (Issue #132)
- [ ] T007 [P] Add piece state tests (type, rotation, origin) in TetrisGame.Tests/Domain/PieceTests.cs (Issue #133)
- [ ] T008 Implement Piece state and movement operations in TetrisGame/Domain/Piece.cs (Issue #134)
- [ ] T009 [P] Add 7-bag distribution tests for all tetrominoes in TetrisGame.Tests/Domain/PieceFactoryTests.cs (Issue #135)
- [ ] T010 Implement PieceFactory with shuffled 7-bag generator in TetrisGame/Domain/PieceFactory.cs (Issue #136)
- [ ] T011 [P] Add clockwise rotation behavior tests by piece type in TetrisGame.Tests/Domain/PieceRotationTests.cs (Issue #137)
- [ ] T012 Implement clockwise rotation rules in TetrisGame/Domain/Piece.cs (Issue #138)
- [ ] T013 [P] Add collision rejection tests (walls and settled cells) in TetrisGame.Tests/Domain/BoardCollisionTests.cs (Issue #139)
- [ ] T014 Implement collision validation (`CanPlace`) in TetrisGame/Domain/Board.cs (Issue #140)
- [ ] T015 [P] Add lock/fixation tests when downward move is blocked in TetrisGame.Tests/Domain/BoardLockTests.cs (Issue #141)
- [ ] T016 Implement piece lock/fixation behavior in TetrisGame/Domain/Board.cs (Issue #142)
- [ ] T017 [P] Add line clear tests (single and multi-line) in TetrisGame.Tests/Domain/BoardLineClearTests.cs (Issue #143)
- [ ] T018 Implement complete-line cleanup and row shift in TetrisGame/Domain/Board.cs (Issue #144)
- [ ] T019 [P] Add scoring table tests (1/2/3/4 lines -> 100/300/500/800) in TetrisGame.Tests/Domain/ScoreSystemTests.cs (Issue #145)
- [ ] T020 Implement score update policy in TetrisGame/Domain/ScoreSystem.cs (Issue #146)
- [ ] T021 [P] Add level and gravity interval tests (`max(1000-((level-1)*100),100)`) in TetrisGame.Tests/Domain/LevelProgressionTests.cs (Issue #147)
- [ ] T022 Implement level progression and interval calculation in TetrisGame/Domain/ScoreSystem.cs (Issue #148)
- [ ] T023 [P] [US1] Add game loop cadence tests in TetrisGame.Tests/Loop/GameTickTests.cs (Issue #149)
- [ ] T024 [US1] Implement synchronous tick loop and gravity accumulator in TetrisGame/Domain/GameEngine.cs (Issue #150)
- [ ] T025 [US1] Implement input command enum and mapping contract in TetrisGame/Domain/InputCommand.cs (Issue #151)
- [ ] T026 [US1] Implement non-blocking keyboard polling (`Console.KeyAvailable`) in TetrisGame/Input/KeyboardInputProvider.cs (Issue #152)
- [ ] T027 [US1] Integrate input + tick orchestration in TetrisGame/Program.cs (Issue #153)
- [ ] T028 [US1] Integrate lock-and-spawn flow into runtime state in TetrisGame/Domain/GameState.cs (Issue #154)
- [ ] T029 [US2] Implement frame rendering for board + active piece overlay in TetrisGame/Rendering/ConsoleRenderer.cs (Issue #155)
- [ ] T030 [US2] Implement next-piece preview panel in TetrisGame/Rendering/ConsoleRenderer.cs (Issue #156)
- [ ] T031 [US2] Render current score in info panel in TetrisGame/Rendering/ConsoleRenderer.cs (Issue #157)
- [ ] T032 [US3] Render current level in info panel in TetrisGame/Rendering/ConsoleRenderer.cs (Issue #158)
- [ ] T033 [US3] Apply updated gravity interval after level-up in TetrisGame/Domain/GameEngine.cs (Issue #159)
- [ ] T034 [US2] Wire renderer update cycle in main runtime loop in TetrisGame/Program.cs (Issue #160)
- [ ] T035 [P] [US4] Add game-over and replay flow tests in TetrisGame.Tests/Domain/GameStateGameOverTests.cs (Issue #161)
- [ ] T036 [US4] Implement spawn-collision game-over transition in TetrisGame/Domain/GameState.cs (Issue #162)
- [ ] T037 [US4] Implement game-over screen with final score and replay prompt in TetrisGame/Rendering/ConsoleRenderer.cs (Issue #163)
- [ ] T038 [US4] Implement replay (`S`) and exit (`N`) control handling in TetrisGame/Program.cs (Issue #164)
- [ ] T039 [US4] Implement full reset behavior (board, score, level, bag) in TetrisGame/Domain/GameState.cs (Issue #165)
- [ ] T040 Execute full regression test suite in TetrisGame.Tests/ (Issue #166)
- [ ] T041 Align run/test steps with final implementation in specs/001-tetris-console-game/quickstart.md (Issue #167)
- [ ] T042 Add MVP smoke checklist for manual validation in specs/001-tetris-console-game/checklists/mvp-smoke.md (Issue #168)

...
*Last synced: 2026-04-07T14:42:53.763Z*
...
- [ ] T001 Create .NET solution and projects in TetrisGame.sln (Issue #85)
- [ ] T002 Create architecture folders and placeholders in TetrisGame/Domain/.gitkeep (Issue #86)
- [ ] T003 [P] Configure xUnit project reference and test runner in TetrisGame.Tests/TetrisGame.Tests.csproj (Issue #87)
- [ ] T004 [P] Set C# 14 language version in TetrisGame/TetrisGame.csproj (Issue #88)
- [ ] T005 [P] Add board invariants tests (10x20, bounds) in TetrisGame.Tests/Domain/BoardTests.cs (Issue #89)
- [ ] T006 Implement Board dimensions and bounds checks in TetrisGame/Domain/Board.cs (Issue #90)
- [ ] T007 [P] Add piece state tests (type, rotation, origin) in TetrisGame.Tests/Domain/PieceTests.cs (Issue #91)
- [ ] T008 Implement Piece state and movement operations in TetrisGame/Domain/Piece.cs (Issue #92)
- [ ] T009 [P] Add 7-bag distribution tests for all tetrominoes in TetrisGame.Tests/Domain/PieceFactoryTests.cs (Issue #93)
- [ ] T010 Implement PieceFactory with shuffled 7-bag generator in TetrisGame/Domain/PieceFactory.cs (Issue #94)
- [ ] T011 [P] Add clockwise rotation behavior tests by piece type in TetrisGame.Tests/Domain/PieceRotationTests.cs (Issue #95)
- [ ] T012 Implement clockwise rotation rules in TetrisGame/Domain/Piece.cs (Issue #96)
- [ ] T013 [P] Add collision rejection tests (walls and settled cells) in TetrisGame.Tests/Domain/BoardCollisionTests.cs (Issue #97)
- [ ] T014 Implement collision validation (`CanPlace`) in TetrisGame/Domain/Board.cs (Issue #98)
- [ ] T015 [P] Add lock/fixation tests when downward move is blocked in TetrisGame.Tests/Domain/BoardLockTests.cs (Issue #99)
- [ ] T016 Implement piece lock/fixation behavior in TetrisGame/Domain/Board.cs (Issue #100)
- [ ] T017 [P] Add line clear tests (single and multi-line) in TetrisGame.Tests/Domain/BoardLineClearTests.cs (Issue #101)
- [ ] T018 Implement complete-line cleanup and row shift in TetrisGame/Domain/Board.cs (Issue #102)
- [ ] T019 [P] Add scoring table tests (1/2/3/4 lines -> 100/300/500/800) in TetrisGame.Tests/Domain/ScoreSystemTests.cs (Issue #103)
- [ ] T020 Implement score update policy in TetrisGame/Domain/ScoreSystem.cs (Issue #104)
- [ ] T021 [P] Add level and gravity interval tests (`max(1000-((level-1)*100),100)`) in TetrisGame.Tests/Domain/LevelProgressionTests.cs (Issue #105)
- [ ] T022 Implement level progression and interval calculation in TetrisGame/Domain/ScoreSystem.cs (Issue #106)
- [ ] T023 [P] [US1] Add game loop cadence tests in TetrisGame.Tests/Loop/GameTickTests.cs (Issue #107)
- [ ] T024 [US1] Implement synchronous tick loop and gravity accumulator in TetrisGame/Domain/GameEngine.cs (Issue #108)
- [ ] T025 [US1] Implement input command enum and mapping contract in TetrisGame/Domain/InputCommand.cs (Issue #109)
- [ ] T026 [US1] Implement non-blocking keyboard polling (`Console.KeyAvailable`) in TetrisGame/Input/KeyboardInputProvider.cs (Issue #110)
- [ ] T027 [US1] Integrate input + tick orchestration in TetrisGame/Program.cs (Issue #111)
- [ ] T028 [US1] Integrate lock-and-spawn flow into runtime state in TetrisGame/Domain/GameState.cs (Issue #112)
- [ ] T029 [US2] Implement frame rendering for board + active piece overlay in TetrisGame/Rendering/ConsoleRenderer.cs (Issue #113)
- [ ] T030 [US2] Implement next-piece preview panel in TetrisGame/Rendering/ConsoleRenderer.cs (Issue #114)
- [ ] T031 [US2] Render current score in info panel in TetrisGame/Rendering/ConsoleRenderer.cs (Issue #115)
- [ ] T032 [US3] Render current level in info panel in TetrisGame/Rendering/ConsoleRenderer.cs (Issue #116)
- [ ] T033 [US3] Apply updated gravity interval after level-up in TetrisGame/Domain/GameEngine.cs (Issue #117)
- [ ] T034 [US2] Wire renderer update cycle in main runtime loop in TetrisGame/Program.cs (Issue #118)
- [ ] T035 [P] [US4] Add game-over and replay flow tests in TetrisGame.Tests/Domain/GameStateGameOverTests.cs (Issue #119)
- [ ] T036 [US4] Implement spawn-collision game-over transition in TetrisGame/Domain/GameState.cs (Issue #120)
- [ ] T037 [US4] Implement game-over screen with final score and replay prompt in TetrisGame/Rendering/ConsoleRenderer.cs (Issue #121)
- [ ] T038 [US4] Implement replay (`S`) and exit (`N`) control handling in TetrisGame/Program.cs (Issue #122)
- [ ] T039 [US4] Implement full reset behavior (board, score, level, bag) in TetrisGame/Domain/GameState.cs (Issue #123)
- [ ] T040 Execute full regression test suite in TetrisGame.Tests/ (Issue #124)
- [ ] T041 Align run/test steps with final implementation in specs/001-tetris-console-game/quickstart.md (Issue #125)
- [ ] T042 Add MVP smoke checklist for manual validation in specs/001-tetris-console-game/checklists/mvp-smoke.md (Issue #126)

...
*Last synced: 2026-04-07T10:52:57.621Z*
...
- [ ] T001 Create .NET solution and projects in TetrisGame.sln (Issue #1)
- [ ] T002 Create architecture folders and placeholders in TetrisGame/Domain/.gitkeep (Issue #2)
- [ ] T003 [P] Configure xUnit project reference and test runner in TetrisGame.Tests/TetrisGame.Tests.csproj (Issue #3)
- [ ] T004 [P] Set C# 14 language version in TetrisGame/TetrisGame.csproj (Issue #4)
- [ ] T005 [P] Add board invariants tests (10x20, bounds) in TetrisGame.Tests/Domain/BoardTests.cs (Issue #5)
- [ ] T006 Implement Board dimensions and bounds checks in TetrisGame/Domain/Board.cs (Issue #6)
- [ ] T007 [P] Add piece state tests (type, rotation, origin) in TetrisGame.Tests/Domain/PieceTests.cs (Issue #7)
- [ ] T008 Implement Piece state and movement operations in TetrisGame/Domain/Piece.cs (Issue #8)
- [ ] T009 [P] Add 7-bag distribution tests for all tetrominoes in TetrisGame.Tests/Domain/PieceFactoryTests.cs (Issue #9)
- [ ] T010 Implement PieceFactory with shuffled 7-bag generator in TetrisGame/Domain/PieceFactory.cs (Issue #10)
- [ ] T011 [P] Add clockwise rotation behavior tests by piece type in TetrisGame.Tests/Domain/PieceRotationTests.cs (Issue #11)
- [ ] T012 Implement clockwise rotation rules in TetrisGame/Domain/Piece.cs (Issue #12)
- [ ] T013 [P] Add collision rejection tests (walls and settled cells) in TetrisGame.Tests/Domain/BoardCollisionTests.cs (Issue #13)
- [ ] T014 Implement collision validation (`CanPlace`) in TetrisGame/Domain/Board.cs (Issue #14)
- [ ] T015 [P] Add lock/fixation tests when downward move is blocked in TetrisGame.Tests/Domain/BoardLockTests.cs (Issue #15)
- [ ] T016 Implement piece lock/fixation behavior in TetrisGame/Domain/Board.cs (Issue #16)
- [ ] T017 [P] Add line clear tests (single and multi-line) in TetrisGame.Tests/Domain/BoardLineClearTests.cs (Issue #17)
- [ ] T018 Implement complete-line cleanup and row shift in TetrisGame/Domain/Board.cs (Issue #18)
- [ ] T019 [P] Add scoring table tests (1/2/3/4 lines -> 100/300/500/800) in TetrisGame.Tests/Domain/ScoreSystemTests.cs (Issue #19)
- [ ] T020 Implement score update policy in TetrisGame/Domain/ScoreSystem.cs (Issue #20)
- [ ] T021 [P] Add level and gravity interval tests (`max(1000-((level-1)*100),100)`) in TetrisGame.Tests/Domain/LevelProgressionTests.cs (Issue #21)
- [ ] T022 Implement level progression and interval calculation in TetrisGame/Domain/ScoreSystem.cs (Issue #22)
- [ ] T023 [P] [US1] Add game loop cadence tests in TetrisGame.Tests/Loop/GameTickTests.cs (Issue #23)
- [ ] T024 [US1] Implement synchronous tick loop and gravity accumulator in TetrisGame/Domain/GameEngine.cs (Issue #24)
- [ ] T025 [US1] Implement input command enum and mapping contract in TetrisGame/Domain/InputCommand.cs (Issue #25)
- [ ] T026 [US1] Implement non-blocking keyboard polling (`Console.KeyAvailable`) in TetrisGame/Input/KeyboardInputProvider.cs (Issue #26)
- [ ] T027 [US1] Integrate input + tick orchestration in TetrisGame/Program.cs (Issue #27)
- [ ] T028 [US1] Integrate lock-and-spawn flow into runtime state in TetrisGame/Domain/GameState.cs (Issue #28)
- [ ] T029 [US2] Implement frame rendering for board + active piece overlay in TetrisGame/Rendering/ConsoleRenderer.cs (Issue #29)
- [ ] T030 [US2] Implement next-piece preview panel in TetrisGame/Rendering/ConsoleRenderer.cs (Issue #30)
- [ ] T031 [US2] Render current score in info panel in TetrisGame/Rendering/ConsoleRenderer.cs (Issue #31)
- [ ] T032 [US3] Render current level in info panel in TetrisGame/Rendering/ConsoleRenderer.cs (Issue #32)
- [ ] T033 [US3] Apply updated gravity interval after level-up in TetrisGame/Domain/GameEngine.cs (Issue #33)
- [ ] T034 [US2] Wire renderer update cycle in main runtime loop in TetrisGame/Program.cs (Issue #34)
- [ ] T035 [P] [US4] Add game-over and replay flow tests in TetrisGame.Tests/Domain/GameStateGameOverTests.cs (Issue #35)
- [ ] T036 [US4] Implement spawn-collision game-over transition in TetrisGame/Domain/GameState.cs (Issue #36)
- [ ] T037 [US4] Implement game-over screen with final score and replay prompt in TetrisGame/Rendering/ConsoleRenderer.cs (Issue #37)
- [ ] T038 [US4] Implement replay (`S`) and exit (`N`) control handling in TetrisGame/Program.cs (Issue #38)
- [ ] T039 [US4] Implement full reset behavior (board, score, level, bag) in TetrisGame/Domain/GameState.cs (Issue #39)
- [ ] T040 Execute full regression test suite in TetrisGame.Tests/ (Issue #40)
- [ ] T041 Align run/test steps with final implementation in specs/001-tetris-console-game/quickstart.md (Issue #41)
- [ ] T042 Add MVP smoke checklist for manual validation in specs/001-tetris-console-game/checklists/mvp-smoke.md (Issue #42)
